...
@Component({
  selector: 'app-update-colection',
  templateUrl: './update-colection.component.html',
  styleUrls: ['./update-colection.component.scss']
})
export class UpdateColectionComponent implements OnInit {
  nameId: number;
  value?: IName;
  nameForm!:FormGroup;
  ...
  onSubmit()
  {
    ...
    this.shopService.updateCollection(values).subscribe(
      response => {
